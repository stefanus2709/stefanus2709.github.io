            ...
            <div className="chat chat-start p-5">
                <div className='mt-auto'>
                    <div className="avatar online">
                        <div className="phone:w-10 w-20 rounded-full">
                            <img src={myFace} />
                        </div>
                    </div>
                </div>
                ...
                hover:text-white hover:cursor-pointer">
                    <p className="font-mono phone:text-sm sm:text-2xl text-5xl font-bold">Hello, I'm Stefanus Likardi</p>
                    <p className="font-mono phone:text-xs sm:text-lg text-3xl font-bold">Fresh Graduate Software Engineer</p>
                    <br/>
                    <p className="font-mono phone:text-xs sm:text-xs text-base">
                    ...
                    <br/>
                    <div className="font-mono phone:text-xs sm:text-xs text-base text-end">
